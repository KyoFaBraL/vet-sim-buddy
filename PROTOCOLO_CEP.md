...
### Simulador Veterinário Gamificado para Ensino de Equilíbrio Ácido-Base em Pequenos Animais: Desenvolvimento e Validação de Ferramenta Educacional de M-Learning
...
4. [Tema e Delimitação](#4-tema-e-delimitação)
5. [Problema da Pesquisa](#5-problema-da-pesquisa)
6. [Revisão da Literatura](#6-revisão-da-literatura)
7. [Objetivos](#7-objetivos)
8. [Metodologia](#8-metodologia)
9. [Orçamento](#9-orçamento)
...
A Revolução Industrial 4.0 tem transformado significativamente o cenário educacional, integrando tecnologias digitais aos processos de ensino-aprendizagem. Na medicina veterinária, os distúrbios do equilíbrio ácido-base (EAB) representam um dos desafios mais complexos no intensivismo, envolvendo conceitos intrincados como pH sanguíneo, bicarbonato (HCO₃⁻), pressão parcial de CO₂ (PaCO₂) e anion gap.

O ensino desses distúrbios exige tomada de decisões clínicas rápidas e precisas, especialmente em pacientes críticos, constituindo um obstáculo significativo para estudantes e profissionais recém-formados. Contudo, o ensino tradicional frequentemente se limita a aulas expositivas, com escassas oportunidades de prática clínica em ambiente controlado e seguro.

A aprendizagem móvel (m-learning) emerge como alternativa promissora, aproveitando a ubiquidade dos dispositivos móveis — com 81,43% dos brasileiros utilizando Android — para transformar smartphones em ferramentas educacionais efetivas. Nesse contexto, a gamificação — aplicação de elementos de design de jogos em contextos não lúdicos — tem demonstrado resultados positivos na educação em saúde, promovendo aprendizagem ativa, feedback imediato e motivação intrínseca (DETERDING et al., 2011).

O presente projeto propõe o desenvolvimento e a validação de um simulador veterinário gamificado denominado **VetBalance**, voltado ao ensino de equilíbrio ácido-base em pequenos animais (cães e gatos), como ferramenta complementar de m-learning para estudantes de medicina veterinária.

### 3.1 Justificativa

1. **Lacuna educacional:** O ensino tradicional de EAB frequentemente se limita a aulas expositivas, com escassas oportunidades de prática clínica em ambiente controlado e seguro.

2. **Evidências na literatura:** Estudos demonstram que a gamificação promove maior engajamento, motivação e retenção de conhecimento em contextos educacionais (DETERDING et al., 2011; HAMARI et al., 2014).

3. **Carência de ferramentas:** Não existem ferramentas similares voltadas especificamente ao ensino de equilíbrio ácido-base em medicina veterinária de pequenos animais no contexto brasileiro.

4. **Potencial de impacto:** A ferramenta poderá ser disponibilizada gratuitamente para outras instituições de ensino, democratizando o acesso à educação continuada de qualidade.

5. **Alinhamento institucional:** O projeto contribui para o fortalecimento das ações de inovação tecnológica educacional do programa de pós-graduação.
...
Uso de tecnologias educacionais gamificadas (m-learning) no ensino de equilíbrio ácido-base em medicina veterinária de pequenos animais.

### 4.2 Delimitação

O estudo delimita-se à validação pedagógica do software **VetBalance** junto a estudantes de graduação em Medicina Veterinária da Universidade Federal do Piauí (UFPI), matriculados nas disciplinas de Fisiologia Animal e/ou Farmacologia no semestre 2026.1. A validação abrange exclusivamente o ensino de distúrbios do equilíbrio ácido-base (acidose/alcalose metabólica, acidose/alcalose respiratória e distúrbios mistos) em cães e gatos, por meio de simulações clínicas gamificadas em ambiente digital.

### 4.3 Título Abreviado

**VetBalance: Validação de Simulador Gamificado para Ensino Veterinário**

### 4.4 Palavras-chave

Gamificação; Ensino veterinário; M-learning; Equilíbrio ácido-base; Simulação clínica; Tecnologia educacional.
...
Como a utilização de um simulador veterinário gamificado, em modalidade m-learning, pode contribuir para a melhoria do desempenho acadêmico e da competência clínica de estudantes de medicina veterinária no diagnóstico e tratamento de distúrbios do equilíbrio ácido-base em pequenos animais?

### 5.2 Antecedentes Científicos

Os distúrbios do equilíbrio ácido-base são frequentes em pacientes veterinários críticos e incluem acidose metabólica, alcalose metabólica, acidose respiratória, alcalose respiratória e distúrbios mistos. O diagnóstico requer interpretação integrada de múltiplos parâmetros: pH arterial, PaCO₂, HCO₃⁻, PaO₂, eletrólitos, lactato e anion gap (DIBARTOLA, 2012).

Estudos recentes apontam que simulações gamificadas podem melhorar habilidades de tomada de decisão clínica (GRAAFLAND et al., 2012). A gamificação promove maior engajamento, motivação e retenção de conhecimento em contextos educacionais (HAMARI et al., 2014). No entanto, há escassez de ferramentas voltadas especificamente ao ensino de EAB em medicina veterinária de pequenos animais no contexto brasileiro.

### 5.3 Dados que Justificam a Pesquisa

- A taxa de erro diagnóstico em distúrbios ácido-base entre estudantes de veterinária é elevada, indicando necessidade de métodos complementares de ensino.
- O m-learning permite aprendizagem ubíqua, possibilitando que estudantes acessem conteúdo educacional de qualquer lugar e a qualquer momento (CROMPTON, 2013).
- A alta penetração de smartphones no Brasil (81,43% Android) viabiliza a adoção de ferramentas educacionais móveis.
- Não existem, até o momento, ferramentas gamificadas voltadas ao ensino de EAB em pequenos animais no cenário nacional.

### 5.4 Hipóteses

#### 5.4.1 Hipótese Alternativa (H₁)

Estudantes de medicina veterinária que utilizam o simulador gamificado VetBalance como ferramenta complementar de ensino apresentarão desempenho significativamente superior (p < 0,05) em avaliações teórico-práticas sobre equilíbrio ácido-base em comparação com estudantes que recebem apenas ensino tradicional.

#### 5.4.2 Hipótese Nula (H₀)

Não há diferença estatisticamente significativa no desempenho acadêmico entre estudantes que utilizam o VetBalance e estudantes que recebem apenas ensino tradicional.

---

## 6. REVISÃO DA LITERATURA

### 6.1 Equilíbrio Ácido-Base em Medicina Veterinária

Os distúrbios do equilíbrio ácido-base são frequentes em pacientes veterinários críticos e incluem acidose metabólica, alcalose metabólica, acidose respiratória, alcalose respiratória e distúrbios mistos. O diagnóstico requer interpretação integrada de múltiplos parâmetros: pH arterial, PaCO₂, HCO₃⁻, PaO₂, eletrólitos, lactato e anion gap (DIBARTOLA, 2012).

A complexidade desses distúrbios torna imprescindível que o estudante de medicina veterinária desenvolva competências tanto teóricas quanto práticas para a correta identificação, classificação e manejo terapêutico. No entanto, as oportunidades de prática clínica supervisionada são limitadas pelas restrições de tempo, custo e disponibilidade de casos reais adequados ao ensino.

### 6.2 Gamificação na Educação em Saúde

A gamificação — aplicação de elementos de design de jogos em contextos não lúdicos — tem demonstrado resultados positivos na educação em saúde, promovendo aprendizagem ativa, feedback imediato e motivação intrínseca (DETERDING et al., 2011). Estudos recentes apontam que simulações gamificadas podem melhorar habilidades de tomada de decisão clínica (GRAAFLAND et al., 2012).

Elementos como sistemas de pontos, rankings, badges (conquistas), narrativa e feedback imediato têm sido associados ao aumento do engajamento e da motivação dos estudantes (HAMARI; KOIVISTO; SARSA, 2014).

### 6.3 M-Learning e Tecnologias Educacionais

O m-learning permite aprendizagem ubíqua, possibilitando que estudantes acessem conteúdo educacional de qualquer lugar e a qualquer momento, utilizando dispositivos pessoais (CROMPTON, 2013). Esta modalidade é particularmente relevante em países com alta penetração de smartphones, como o Brasil.

A combinação de m-learning com gamificação representa uma abordagem inovadora e alinhada às tendências da Educação 4.0, permitindo experiências de aprendizagem personalizadas, interativas e baseadas em evidências.
...
Validar a eficácia pedagógica do software educacional gamificado VetBalance como ferramenta complementar de m-learning no ensino de equilíbrio ácido-base em pequenos animais, junto a estudantes de medicina veterinária.

### 7.2 Objetivos Específicos

1. Comparar o desempenho acadêmico entre o grupo experimental (com acesso ao VetBalance) e o grupo controle (ensino tradicional) por meio de avaliações teórico-práticas em quatro momentos distintos (O₁ a O₄).

2. Avaliar a evolução longitudinal do aprendizado dos estudantes do grupo experimental ao longo das 20 semanas de intervenção.

3. Investigar a correlação entre o desempenho no simulador (taxa de vitória, badges conquistados, tempo de resposta) e as notas nas avaliações acadêmicas.

4. Avaliar a usabilidade e satisfação dos estudantes com o software por meio de questionário adaptado da Escala de Usabilidade do Sistema (SUS).

5. Verificar se o software atende aos critérios de qualidade da norma ISO/IEC 25010:2011 (adequação funcional, eficiência, usabilidade, confiabilidade, segurança e portabilidade).
...
O₂ = Avaliação intermediária 1 – distúrbios metabólicos (Maio/2026)
O₃ = Avaliação intermediária 2 – distúrbios respiratórios e mistos (Junho/2026)
O₄ = Pós-teste final abrangente (Junho/2026)
```

#### 8.1.2 Descrição do Software (SUT — System Under Test)
...
| **Plataformas** | Chrome ≥ 90, Firefox ≥ 88, Safari ≥ 14, Edge ≥ 90 (desktop e mobile) |
| **Casos clínicos** | 7 pré-definidos (cães e gatos) com 9 condições clínicas modeladas |
| **Parâmetros monitorados** | 10 (pH, PaO₂, PaCO₂, FC, FR, Temperatura, HCO₃⁻, Lactato, PA, Hemoglobina) |
| **Tratamentos** | 8 (Bicarbonato, Oxigenoterapia, Fluidoterapia, entre outros) |
| **Gamificação** | HP (Health Points), 17 badges, ranking semanal, feedback por IA |
| **Modos** | Prática (com dicas de IA) e Avaliação (sem dicas) |
| **Exportação** | Relatórios em CSV e TXT |

### 8.2 Definição da Amostra e Cálculo Amostral
...
**Desfecho Primário:** Diferença no desempenho acadêmico entre GE e GC no pós-teste final (O₄), medida pela nota na avaliação abrangente de equilíbrio ácido-base (escala 0–10). Critério de sucesso: diferença estatisticamente significativa (p < 0,05) com tamanho de efeito d de Cohen ≥ 0,8 (efeito grande).

**Desfechos Secundários:**

| ID | Desfecho | Métrica | Critério |
|----|----------|---------|----------|
| DS-01 | Evolução longitudinal do GE | Δ(O₄ − O₁) pareado | p < 0,05 (teste t pareado) |
| DS-02 | Correlação uso do software × desempenho | r de Pearson (win rate × nota O₄) | r ≥ 0,3 com p < 0,05 |
| DS-03 | Usabilidade do software | Média do questionário SUS adaptado | ≥ 4,0/5,0 |
| DS-04 | Engajamento no software | Nº de sessões, badges, win rate | Análise descritiva |
| DS-05 | Desempenho intermediário | Notas em O₂ e O₃ (GE vs GC) | Análise comparativa |

### 8.4 Análise Crítica de Riscos e Benefícios
...
|---------------------|---------------|---------------|----------------------|
| Desconforto emocional ao perceber baixo desempenho nas avaliações | Mínimo | Baixa | As avaliações são componentes regulares das disciplinas; feedback individual e confidencial será fornecido |
| Frustração ao utilizar o software (GE) | Mínimo | Baixa | Tutorial guiado; suporte técnico disponível; sistema de gamificação com reforço positivo |
| Sensação de desvantagem por pertencer ao GC | Mínimo | Média | Garantia de acesso ao software após a conclusão da coleta de dados; esclarecimento no TCLE |
| Quebra de sigilo de dados pessoais | Mínimo | Muito baixa | Dados armazenados com criptografia; RLS (Row Level Security) em 100% das tabelas; anonimização antes da publicação |
| Fadiga por uso prolongado de tela | Mínimo | Baixa | Sessões de simulação limitadas a ~5 minutos cada; uso voluntário e no ritmo do participante |

#### 8.4.2 Benefícios

| Benefício | Destinatário |
|-----------|--------------|
| Prática complementar de tomada de decisão clínica em ambiente seguro | Participantes do GE (e GC após a coleta) |
| Feedback personalizado sobre desempenho por inteligência artificial | Participantes do GE |
| Desenvolvimento de competências em interpretação de parâmetros de EAB | Todos os participantes |
| Contribuição para o avanço da pesquisa em tecnologia educacional veterinária | Comunidade acadêmica |
| Acesso gratuito a ferramenta educacional inovadora | Todos os participantes (pós-estudo) |
| Potencial melhoria no desempenho nas disciplinas cursadas | Participantes do GE |

#### 8.4.3 Relação Risco-Benefício

A relação risco-benefício é **favorável**, uma vez que os riscos são mínimos e os benefícios são diretos e relevantes para a formação acadêmica dos participantes. A intervenção é complementar ao ensino regular e não substitui atividades curriculares obrigatórias.

### 8.5 Forma de Recrutamento e Obtenção do TCLE
...
- O direito de desistência a qualquer momento, sem prejuízo acadêmico.

A apresentação será realizada na presença do docente responsável pela disciplina.
...
Adicionalmente, o consentimento será registrado digitalmente no software VetBalance no primeiro acesso do participante, com registro de IP, user-agent e timestamp, conforme exigências da LGPD e para fins de rastreabilidade.

### 8.6 Procedimentos a que Serão Submetidos os Participantes

#### 8.6.1 Grupo Experimental (GE)

Os participantes do GE receberão, além do ensino tradicional (aulas teóricas presenciais), acesso ao software VetBalance para prática complementar. A intervenção consistirá em:

1. **Treinamento inicial** (1 semana): Tutorial guiado sobre a interface e funcionalidades do software
2. **Uso supervisionado** (1 semana): Prática com casos de complexidade básica (acidose/alcalose metabólica) sob supervisão
3. **Uso intensivo** (6 semanas): Prática autônoma com todos os 7 casos clínicos disponíveis, em modo Prática (com dicas de IA) e modo Avaliação (sem dicas)
4. **Revisão geral** (1 semana): Prática final com todos os casos

O software registrará automaticamente todos os dados de uso: sessões realizadas, decisões clínicas, tratamentos aplicados, parâmetros monitorados, conquistas e tempo de jogo.
...
Não existem métodos alternativos equivalentes ao proposto nesta pesquisa. O ensino tradicional (aulas expositivas) é o método padrão atual, sendo utilizado como controle. O VetBalance é a única ferramenta gamificada de m-learning desenvolvida especificamente para o ensino de equilíbrio ácido-base em pequenos animais no contexto brasileiro.

A escolha do delineamento quase-experimental com grupo controle (sem software) justifica-se pela necessidade de isolar o efeito da ferramenta educacional sobre o desempenho acadêmico. Ao final do estudo, o GC receberá acesso integral ao software, garantindo equidade ética.

### 8.8 Critérios de Inclusão e Exclusão

#### 8.8.1 Critérios de Inclusão
...
5. Concordar em participar voluntariamente e assinar o Termo de Consentimento Livre e Esclarecido (TCLE).

#### 8.8.2 Critérios de Exclusão

1. Participantes que não possuam acesso regular à internet.
2. Participantes que tenham cursado disciplinas avançadas de clínica médica de pequenos animais ou intensivismo veterinário.
3. Participantes que apresentem conflito de interesse com a pesquisa (e.g., envolvimento no desenvolvimento do software).

**Justificativa:** Todos os participantes são maiores de 18 anos e estudantes de graduação, não se tratando de grupo vulnerável ou especial. Não há necessidade de Termo de Assentimento.

#### 8.8.3 Critérios de Descontinuação

1. Desistência voluntária do participante a qualquer momento, sem necessidade de justificativa.
2. Trancamento de matrícula ou desligamento do curso durante o período da pesquisa.
3. Frequência inferior a 75% nas atividades presenciais das disciplinas envolvidas.
4. Solicitação de retirada do consentimento.

### 8.9 Monitoramento da Coleta e Segurança dos Participantes

#### 8.9.1 Ações de Monitoramento

- **Acompanhamento semanal:** O pesquisador verificará semanalmente os logs do sistema para monitorar o engajamento dos participantes do GE e identificar eventuais dificuldades técnicas.
- **Suporte técnico:** Canal de comunicação (e-mail e WhatsApp) disponível para resolução de problemas técnicos durante todo o período de intervenção.
- **Reuniões com docentes:** Encontros quinzenais com os professores das disciplinas para acompanhar o andamento da pesquisa e identificar eventuais intercorrências.
- **Monitoramento de integridade dos dados:** Verificação automatizada da consistência dos dados coletados pelo software (sessões, tratamentos, parâmetros).

#### 8.9.2 Preservação da Privacidade e Confidencialidade

| Medida | Descrição |
|--------|-----------|
| **Controle de acesso** | Row Level Security (RLS) habilitado em 100% das tabelas do banco de dados |
| **Autenticação** | E-mail + senha com verificação obrigatória |
| **Anonimização** | Dados identificáveis serão substituídos por códigos alfanuméricos antes da publicação |
| **Armazenamento** | Dados mantidos em servidor seguro com criptografia em trânsito (HTTPS/TLS) e em repouso |
| **Retenção** | Dados armazenados por 5 anos conforme normas institucionais, com posterior eliminação segura |
| **Exclusão** | Participantes podem solicitar exclusão de seus dados a qualquer momento |
| **LGPD** | Conformidade com a Lei Geral de Proteção de Dados (Lei 13.709/2018) |
| **Filmagens/gravações** | Não serão realizadas filmagens, fotografias ou gravações de entrevistas com os participantes |
...
A pesquisa é **autofinanciada pelo pesquisador**. Não há patrocinador externo nem promotor. Não há conflito de interesses financeiros. (Detalhes no item 9 — Orçamento.)

### 8.11 Critérios para Suspender ou Encerrar a Pesquisa

#### 8.11.1 Critérios de Encerramento Regular

A pesquisa será considerada concluída quando:

1. Todas as 4 avaliações (O₁ a O₄) forem aplicadas e tabuladas.
2. O questionário de satisfação (I-05) for coletado do GE.
3. Os dados do software forem exportados integralmente.
4. A análise estatística for processada no RStudio.
5. O relatório final de validação for redigido.

#### 8.11.2 Critérios de Suspensão Temporária

A pesquisa poderá ser suspensa temporariamente se:

1. O software apresentar indisponibilidade superior a 72 horas consecutivas durante o período de intervenção.
2. Houver evidência de contaminação sistemática entre os grupos (GC acessando o software).
3. Menos de 50% dos participantes estiverem ativos em qualquer uma das avaliações.
4. O CEP solicitar esclarecimentos adicionais ou suspensão para análise.

#### 8.11.3 Critérios de Encerramento Antecipado

A pesquisa será encerrada antecipadamente se:

1. Menos de 70% dos participantes originais concluírem todas as avaliações programadas.
2. Houver evidência de prejuízo acadêmico aos participantes decorrente da pesquisa.
3. O software apresentar falhas críticas que comprometam a integridade dos dados.

### 8.12 Local da Pesquisa

#### 8.12.1 Instalações e Infraestrutura
...
- **Salas de aula**: Equipadas com projetor multimídia para apresentação e aplicação das avaliações;
- **Rede Wi-Fi institucional**: Cobertura nas áreas utilizadas (salas de aula e laboratórios);
- **Laboratório de informática**: Disponível para eventual uso durante treinamento supervisionado;
- **Ambiente digital**: Software VetBalance (https://vetbalance.lovable.app) acessível via internet a partir de qualquer dispositivo com navegador web moderno.

#### 8.12.3 Demonstrativo de Infraestrutura

A concordância institucional documentada é apresentada no **Anexo E** (Declaração de Infraestrutura e Concordância Institucional), assinada pela Coordenadora do Curso de Graduação em Medicina Veterinária – CCA/UFPI.
...
| **Dependente secundária** | Engajamento | Sessões completadas, taxa de vitória (win rate), badges conquistados |
| **Dependente terciária** | Satisfação | Escala Likert (questionário pós-intervenção SUS adaptado) |
...
| ID | Dado | Tipo | Granularidade |
|----|------|------|---------------|
| D-01 | Sessões de simulação | Quantitativo | Por sessão |
| D-02 | Snapshots de parâmetros fisiológicos | Quantitativo | Por segundo (tick) |
| D-03 | Decisões clínicas tomadas | Qualitativo/Quantitativo | Por evento |
| D-04 | Tratamentos aplicados | Quantitativo | Por evento |
| D-05 | Badges conquistados | Quantitativo | Por conquista |
| D-06 | Ranking semanal | Quantitativo | Semanal |
| D-07 | Notas de simulação do aluno | Qualitativo | Por anotação |

### 8.15 Plano de Análise Estatística

| Análise | Teste Estatístico | Variáveis | Software |
|---------|-------------------|-----------|----------|
| Normalidade dos dados | Shapiro-Wilk | Distribuição das notas | RStudio |
...
| Correlação software × desempenho | Correlação de Pearson | Win rate × nota pós-teste (GE) | RStudio |
| Usabilidade | Estatística descritiva | Médias e DP do questionário SUS | RStudio |

**Software e Pacotes:**

| Item | Especificação |
|------|---------------|
| Software estatístico | RStudio (R ≥ 4.3) |
| Pacotes R | `t.test()`, `shapiro.test()`, `cohen.d()` (pacote `effsize`), `cor.test()` |
...
### 9.1 Orçamento Detalhado

| Item | Custo Estimado (R$) | Responsável/Fonte |
|------|---------------------|-------------------|
| Hospedagem do software e infraestrutura em nuvem | R$ 100,00/mês × 5 meses = R$ 500,00 | Pesquisador (recursos próprios) |
| Plataforma de desenvolvimento e deploy (plano profissional) | R$ 100,00/mês × 5 meses = R$ 500,00 | Pesquisador (recursos próprios) |
| Domínio web (vetbalance.app.br) | R$ 40,00/ano | Pesquisador (recursos próprios) |
| Impressão de TCLEs e instrumentos de coleta | R$ 50,00 | Pesquisador (recursos próprios) |
| Licença RStudio | R$ 0,00 | Software livre (código aberto) |
| **Total estimado (20 semanas)** | **R$ 1.090,00** | — |

### 9.2 Financiamento e Patrocínio
...
> **IMPORTANTE:** A coleta de dados terá início **somente após a aprovação do projeto pelo CEP/UFPI**. Nenhum procedimento de coleta será realizado antes da emissão do parecer consubstanciado favorável. O cronograma abaixo prevê um prazo mínimo de **3 (três) meses** para tramitação do projeto no CEP, considerando a ocorrência de eventuais pendências. Projeto cuja coleta de dados se iniciar antes da aprovação pelo CEP-UFPI será obrigatoriamente **NÃO APROVADO**.

### 10.1 Cronograma Geral (Duração Total: 20 semanas, a partir da aprovação)

| Fase | Período* | Duração | Atividade Principal |
|------|----------|---------|---------------------|
| **Submissão e Tramitação CEP** | **Março–Maio/2026** | **~3 meses** | **Submissão na Plataforma Brasil, análise pelo CEP, eventuais pendências** |
| F1 — Preparação | Semanas 1–3 (após aprovação) | 3 semanas | Apresentação aos docentes, randomização, pré-teste diagnóstico (O₁) |
| F2 — Intervenção Inicial | Semanas 4–6 | 3 semanas | Aulas teóricas (GE + GC), treinamento GE no software |
| *Intervalo* | *1 semana* | *6 dias* | *Intervalo entre F2 e F3 (sem atividades programadas)* |
| F3 — Avaliação Intermediária 1 | Semanas 7–9 | 3 semanas | Uso intensivo GE, avaliação O₂ (distúrbios metabólicos) |
...
### 10.2 Marcos Críticos (Milestones)

| Marco | Momento | Descrição |
|-------|---------|-----------|
| ✅ Aprovação CEP | Antes do início da coleta | Parecer consubstanciado favorável |
| 🔴 O₁ | Semana 3 | Pré-teste diagnóstico (GE + GC) |
| 🔴 O₂ | Semanas 8–9 | Avaliação intermediária 1 — distúrbios metabólicos |
| 🔴 O₃ | Semana 13 | Avaliação intermediária 2 — distúrbios respiratórios e mistos |
...
CAMPBELL, D. T.; STANLEY, J. C. **Experimental and quasi-experimental designs for research**. Boston: Houghton Mifflin, 1963.

COHEN, J. **Statistical power analysis for the behavioral sciences**. 2. ed. Hillsdale: Lawrence Erlbaum Associates, 1988.

CROMPTON, H. A historical overview of mobile learning: Toward learner-centered education. In: BERGE, Z. L.; MUILENBURG, L. Y. (Ed.). **Handbook of mobile learning**. New York: Routledge, 2013. p. 3-14.

DETERDING, S. et al. From game design elements to gamefulness: defining "gamification". In: INTERNATIONAL ACADEMIC MINDTREK CONFERENCE, 15., 2011, Tampere. **Proceedings [...]**. New York: ACM, 2011. p. 9-15.

DIBARTOLA, S. P. **Fluid, electrolyte, and acid-base disorders in small animal practice**. 4. ed. St. Louis: Elsevier Saunders, 2012.

GRAAFLAND, M.; SCHRAAGEN, J. M.; SCHIJVEN, M. P. Systematic review of serious games for medical education and surgical skills training. **British Journal of Surgery**, v. 99, n. 10, p. 1322-1330, 2012.

HAMARI, J.; KOIVISTO, J.; SARSA, H. Does gamification work? – A literature review of empirical studies on gamification. In: HAWAII INTERNATIONAL CONFERENCE ON SYSTEM SCIENCES, 47., 2014, Hawaii. **Proceedings [...]**. IEEE, 2014. p. 3025-3034.

INSTITUTE OF ELECTRICAL AND ELECTRONICS ENGINEERS. **IEEE 829-2008** — Standard for Software and System Test Documentation. New York: IEEE, 2008.
...
## ASPECTOS ÉTICOS (Declaração Complementar)

Esta pesquisa atende aos princípios éticos estabelecidos pela Resolução CNS nº 466/2012:

| Princípio | Atendimento |
|-----------|-------------|
| **Autonomia** | Participação voluntária; TCLE assinado; direito de desistência a qualquer momento |
| **Beneficência** | Benefícios educacionais diretos; ferramenta complementar ao ensino |
| **Não maleficência** | Risco mínimo; nenhuma intervenção invasiva; ensino regular mantido |
| **Justiça** | GC receberá acesso ao software após coleta; seleção equitativa |
| **Equidade** | Randomização estratificada; mesmo conteúdo teórico para ambos os grupos |

A pesquisa enquadra-se parcialmente na Resolução CNS 510/2016 por envolver técnicas e instrumentos educacionais:

- Os dados coletados referem-se a desempenho acadêmico em disciplinas regulares e uso de software educacional.
- Não envolve procedimentos invasivos, coleta de material biológico ou intervenções em saúde.
- A coleta de dados digitais (logs do software) é automatizada e não identificável publicamente.

### Equidade Pós-Estudo

Após a conclusão da fase de coleta de dados, todos os participantes do Grupo Controle receberão **acesso integral ao VetBalance**, garantindo que nenhum participante seja privado dos potenciais benefícios da ferramenta educacional.

---

## REFERÊNCIAS CRUZADAS

| Documento | Relação com este Protocolo CEP |
|-----------|-------------------------------|
| `DOCUMENTACAO_SOFTWARE.md` | Documentação técnica completa do software sob teste (Seções 1–21) |
| `CRONOGRAMA_VALIDACAO.md` (PVS-001) | Plano de Validação IEEE 829 — Seções 5, 8–12 detalham o desenho experimental e análise estatística |
| `ARTIGO_RESUMO_EXPANDIDO.md` | Resumo expandido para publicação — fundamenta-se neste protocolo |
| `RESUMO_EXECUTIVO.md` | Síntese executiva do projeto — Seção 6 resume o estudo de validação |
| `GLOSSARIO.md` | Glossário unificado (43 termos) — padroniza a terminologia |
| `DIAGRAMAS_MERMAID.md` | Diagramas de arquitetura e fluxos do sistema |

---

**Documento elaborado para submissão ao Comitê de Ética em Pesquisa (CEP) via Plataforma Brasil**  
**Pesquisa vinculada ao Programa de Pós-Graduação em Ciência Animal — UFPI**  
**Software disponível em:** https://vetbalance.lovable.app
